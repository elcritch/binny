...
nim=${NIM_NATIVE_DYNLIB_COMPILER:-"../../../Nim/bin/nim"}
nimony=${NIMONY_DIR:-"../../../Nim/dist/nimony"}
...
"$nim" c -d:release --path:"$script_dir/../.." --path:"$nimony/src" \
  --out:"$script_dir/generator" generate.nim
